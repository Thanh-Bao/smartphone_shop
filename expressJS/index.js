...
const baseURL = str =>
    `https://6654aaf7-905f-48ea-b013-3811c03fcba8.abap.us10.hana.ondemand.com/sap/opu/odata/sap/${str}?$format=json`
...
const ZBUI = "ZBUI_PHONE_INFO";
// *****************************************************************************************


app.get(`/${ZBUI}/ZC_PHONE_INFO`, (req, res) => {
    console.log('Hello');
    res.send("Hello")
})
